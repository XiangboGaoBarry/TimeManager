...
const FixedTimeEventsForm = ({setEvent,deleteEvent,setAffair,setStartDate,setStartTime,setTimeSpan,CalendarGenerate,setDeleteEvent,deleteAllEvents}) => {
		return(
			<div className='center'>
				<div className = 'pa4 br3 shadow-5'>
					<input onChange = {setAffair} placeholder="Your Fixed Time Affair" className = 'f4 pa2 w-100 center' type='text'/>
...
export default FixedTimeEventsForm;